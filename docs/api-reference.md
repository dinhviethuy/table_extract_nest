...
### 1.3 GET Chi tiết bảng của một trang cụ thể (Lazy Load)
...
### 2.2 GET Truy vấn trạng thái lô OCR
...
### 2.3 GET Chi tiết văn bản OCR của một trang cụ thể
...
### 2.4 GET Stream tiến trình thời gian thực (SSE)
